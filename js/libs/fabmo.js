...
// TODO ... problem with toaster removal; TH kludge
...
var showToaster = function (toaster) {
	...
	let ckToaster = document.getElementById("alert-toaster");
	if  (ckToaster.parentNode) {
	  setTimeout(removeAlert, 1000);
	}    
// TH setTimeout(function(){document.body.removeChild(toaster)}, 1000);
}
// TH added to get removal of toaster to work ...
var removeAlert = function () {
	let ckToaster = document.getElementById("alert-toaster");
	if  (ckToaster.parentNode) {
	  ckToaster.parentNode.removeChild(ckToaster);
	}    
}
